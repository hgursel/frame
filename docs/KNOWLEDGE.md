...
The model can find saved pages in subsequent turns and other conversations in that project. Optional [Knowledge maintenance](KNOWLEDGE_MAINTENANCE.md) under Settings schedules health checks and bounded learning from completed conversations. Choose whether to review drafts before use or publish eligible pages automatically. No automatic verification, model training, vector database, or cloud service is involved.
